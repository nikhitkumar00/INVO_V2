const Privacypolicy = () => {
  return (
    <div className="w-full px-4 pb-5 ">
      <div className="text-2xl">Privacy Policy for INVO</div>
      <div className="text-sm">
        ...
        Name. This policy is not applicable to any information collected offline
        or via channels other than this website. Consent By using our website,
        you hereby consent to our Privacy Policy and agree to its terms.
        <div className="text-xl">How we use your information</div>
        ...
        you emails Find and prevent fraud Log Files Website Name follows a
        ...
        and gathering demographic information. Cookies and Web Beacons Like any
        other website, Website Name uses ‘cookies'. These cookies are used to
        ...
        on visitors' browser type and/or other information. DoubleClick DART
        Cookie Google is one of a third-party vendor on our site. It also uses
        ...
        following URL – https://policies.google.com/technologies/ads. Some of
        advertisers on our site may use cookies and web beacons. Our advertising
        partners are listed below. Each of our advertising partners has their
        own Privacy Policy for their policies on user data. For easier access,
        we hyperlinked to their Privacy Policies below. Google
        https://policies.google.com/technologies/ads
        <div className="text-xl">Advertising Partners Privacy Policies</div>
        ...
        Website Name, which are sent directly to users' browser. They
        ...
        websites that you visit. Note that Website Name has no access to or
        control over these cookies that are used by third-party advertisers.
        <div className="text-xl">Third Party Privacy Policies</div>
        ...
        be found at the browsers' respective websites. What Are Cookies? CCPA
        Privacy Policy Under the CCPA, among other rights, California consumers
        ...
        these rights, please contact us. GDPR Privacy Policy We would like to
        make sure you are fully aware of all of your data protection rights.
        Every user is entitled to the following: The right to access – You have
        the right to request copies of your personal data. We may charge you a
        small fee for this service. The right to rectification – You have the
        ...
        certain conditions. The right to object to processing – You have the
