  ...
  return (
    <div className="w-full px-4 pb-5 text-justify">
      ...
      <div>
        ...
        website, and gathering demographic information. Cookies and Web Beacons
        ...
        and/or other information. DoubleClick DART Cookie Google is one of a
        ...
        https://policies.google.com/technologies/ads. Some of advertisers on our
      ...
      <div>
        ...
        CCPA Privacy Policy Under the CCPA, among other rights, California
        ...
        a business has collected. Request that a business that sells a
        consumer&apos;s personal data, not sell the consumer&apos;s personal
        data. If you make a request, we have one month to respond to you. If you
        would like to exercise any of these rights, please contact us. GDPR
        Privacy Policy We would like to make sure you are fully aware of all of
        your data protection rights. Every user is entitled to the following:
        The right to access – You have the right to request copies of your
        personal data. We may charge you a small fee for this service. The right
        to rectification – You have the right to request that we correct any
        ...
        monitor and guide their online activity. Website Name does not knowingly
